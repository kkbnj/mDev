  ...
  <meta name="msapplication-TileImage" content="/<?php echo $sp_image_path; ?>/ms-touch-icon-144x144-precomposed.png" />
  <meta name="msapplication-TileColor" content="#CCCCCC" />

  <!-- Add to homescreen for Chrome on Android -->
  <meta name="mobile-web-app-capable" content="yes" />
  <link rel="icon" sizes="192x192" href="/<?php echo $sp_image_path; ?>/chrome-touch-icon-192x192.png" />
  ...
  <link rel="apple-touch-icon" href="/<?php echo $sp_image_path; ?>/apple-touch-icon.png" />

  <link href="//yui.yahooapis.com/3.18.1/build/cssreset/cssreset-min.css" rel="stylesheet" type="text/css" />
  <link href="/<?php echo $sp_css_path; ?>/base.css" rel="stylesheet" type="text/css" />
